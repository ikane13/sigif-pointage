...
import { QrCode, Download, RefreshCw, Copy, Check, FileImage, FileText } from 'lucide-react';
  ...
  return (
    <Card>
      <div className={styles.qrSection}>
        ...
        {!qrInfo ? (
          <div className={styles.empty}>
            ...
            <p>Générez un QR code pour permettre aux participants de pointer leur présence</p>
            <Button
          ...
          <div className={styles.qrContent}>
                ...
                <img 
                  src={`data:image/svg+xml,${encodeURIComponent(`
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200">
                      ...
                      <text x="100" y="100" text-anchor="middle" fill="#0047AB" font-size="16">
                        QR Code généré
                      </text>
                    </svg>
                  `)}`}
            ...
            <div className={styles.qrInfo}>
              ...
              <div className={styles.infoCard}>
                <span className={styles.label}>URL de pointage</span>
      ...
      >
        ...
        <p style={{ marginTop: '0.5rem' }}>L'ancien QR code ne fonctionnera plus.</p>
      </Modal>
    </Card>
  );
};